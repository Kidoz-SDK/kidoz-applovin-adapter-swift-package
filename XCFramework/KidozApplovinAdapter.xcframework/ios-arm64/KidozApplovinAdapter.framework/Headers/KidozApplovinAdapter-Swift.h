...
#ifndef KIDOZAPPLOVINADAPTER_SWIFT_H
#define KIDOZAPPLOVINADAPTER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="KidozApplovinAdapter",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS_NAMED("KidozAppLovinSDKInfo")
...
SWIFT_CLASS_NAMED("KidozMediationAdapter")
@interface KidozMediationAdapter : ALMediationAdapter <MAAdViewAdapter, MAInterstitialAdapter, MARewardedAdapter, KidozBannerDelegate, KidozInitDelegate, KidozInterstitialDelegate, KidozRewardedDelegate>
...
- (void)onInterstitialAdLoadedWithKidozInterstitialAd:(KidozInterstitialAd * _Nonnull)ad;
- (void)onInterstitialAdFailedToLoadWithKidozError:(KidozError * _Nonnull)error;
- (void)onInterstitialAdShownWithKidozInterstitialAd:(KidozInterstitialAd * _Nonnull)ad;
...
- (void)onInterstitialAdClosedWithKidozInterstitialAd:(KidozInterstitialAd * _Nonnull)ad;
...
- (void)onRewardedAdLoadedWithKidozRewardedAd:(KidozRewardedAd * _Nonnull)ad;
- (void)onRewardedAdFailedToLoadWithKidozError:(KidozError * _Nonnull)kidozError;
- (void)onRewardedAdShownWithKidozRewardedAd:(KidozRewardedAd * _Nonnull)ad;
- (void)onRewardedAdFailedToShowWithKidozRewardedAd:(KidozRewardedAd * _Nonnull)ad kidozError:(KidozError * _Nonnull)kidozError;
- (void)onRewardedImpressionWithKidozRewardedAd:(KidozRewardedAd * _Nonnull)ad;
- (void)onRewardReceivedWithKidozRewardedAd:(KidozRewardedAd * _Nonnull)ad;
- (void)onRewardedAdClosedWithKidozRewardedAd:(KidozRewardedAd * _Nonnull)kidozRewardedAd;
- (void)destroy;
- (nonnull instancetype)initWithSdk:(ALSdk * _Nonnull)sdk OBJC_DESIGNATED_INITIALIZER SWIFT_DEPRECATED_MSG("This API is deprecated and will be removed in a future SDK version. Please use `-[ALMediationAdapter init] instead.");
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
